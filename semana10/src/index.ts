...
import VeiculoRepository from './repository/VeiculosRepository';
...
ipcMain.handle('create', async (event: any, veiculo: any) => {
  ...
  const novoVeiculos = new Veiculo(modelo, cor, ano, preco, placa, imagem, id);
  new VeiculoRepository().save(novoVeiculos)
})
...
ipcMain.handle('findById', async (event: any, id: string) => {
